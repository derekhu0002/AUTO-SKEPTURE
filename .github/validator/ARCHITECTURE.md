...
- path: script/validateSystemArchitecture.cjs
  kind: bundled-validator-script
...
- test_id: validator-bootstrap-traceability
  ...
  guards_elements:
    ...
    - script/validateSystemArchitecture.cjs
  protected_baselines:
    - ARCHITECTURE.md
...
### Notes
- The repository-level shims remain at ../../scripts/validateStageHandoff.js and ../../scripts/validateSystemArchitecture.cjs so package.json can expose stable invocation paths without moving the bundled assets.