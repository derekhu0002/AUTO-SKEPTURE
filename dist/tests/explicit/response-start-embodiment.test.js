...
export const CONTROL_POINT = 'AgentRuntime.handleResponseLifecycle({ type: "response_start" })';
export const OBSERVATION_POINT = "Mediator outcome and structured Blender feedback expose a thinking-compatible state.";
